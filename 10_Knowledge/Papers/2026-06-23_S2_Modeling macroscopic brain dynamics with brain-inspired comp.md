...
tags: [brain dynamics, brain-inspired computing, coarse-grained modeling, quantization, classified, inest]
status: inbox
---
...
提出一种结合粗粒度脑建模与脑启发计算架构的流水线，通过动态感知量化实现低精度模拟并保持动力学特性。
