...
tags: [signal integrity, 2.5D advanced packaging, UCIe, chiplet interconnect, classified, tcc]
status: inbox
---
...
基于UCIe协议的2.5D先进封装互连信号完整性仿真与分析，比较硅桥、WLFOP和FCBGA结构，实现32Gbps高速传输。
