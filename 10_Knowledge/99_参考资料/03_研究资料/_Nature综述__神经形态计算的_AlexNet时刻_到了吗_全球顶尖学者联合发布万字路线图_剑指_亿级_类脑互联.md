...
原文链接: https://mp.weixin.qq.com/s/JX9FgYctgrZPklfFK2IGbg
...
## Q3: 对于普通研究者，机会在哪里？算法与编译。 硬件造价昂贵，是巨头的游戏。但中间件（Compiler/Middleware） 和 算法（Algorithm） 是一片蓝海。如何设计一种算法，既能利用SNN的稀疏性，又能保持高精度？如何设计一个编译器，把 PyTorch 代码自动转成脉冲形式跑在 Loihi 上？这些都是顶刊级别的课题。
