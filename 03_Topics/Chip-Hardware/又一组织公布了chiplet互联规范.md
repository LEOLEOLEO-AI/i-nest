...
智能摘要
规范代表了OCP开放域特定架构(ODSA)项目迈向建立开放Chiplet生态系统作为新硅市场和集成电路供应链模型的催化剂的下一步。CPU拆分成几块，还是将47个小芯片放在一个封装上，小芯片已经在今天的芯片设计中发挥着重要作用，芯片制造商已经明确表示它只是将来会成长。对于只需要以具有成本效益的方式将两个小芯片组合在一个封装上的芯片制造商来说，有标准封装方法。对于需要使两个小芯片的性能尽可能接近单个单片芯片的芯片制造商来说，先进的封装规范允许大量通道，从而提供大量带宽。
原文约 5599  字   |  图片 24 张  |  建议阅读 12 分钟  |  [评价反馈](https://static.app.yinxiang.com/embedded-web/clipper/#/Evaluating?d=2022-07-22&nu=d0c3b1f8-2e83-47ec-8226-d0ef088d7038&fr=myyxbj&ud=1bb10ab&v=2&sig=677028CE491B125DC368E33F4765EA90)
...
近日，为所有人带来超大规模创新的非营利组织 OCP 基金会宣布，发布用于 Chiplet 互连的 Bunch of Wires (BoW) 规范。BoW 规范代表了 OCP开放域特定架构 (ODSA) 项目迈向建立开放 Chiplet 生态系统作为新硅市场和集成电路供应链模型的催化剂的下一步。BoW 指定了针对片上系统 (SoC) 分解优化的物理层 (PHY)，并补充了 OCP ODSA开放式高带宽互连 (OpenHBI) PHY 针对高带宽内存和其他并行带宽密集型用例的规范。

“由于工作负载的多样性，例如人工智能和机器学习的采用，对专用硅的需求一直在稳步增长，我们预计这种趋势将持续数年。为了响应这一需求，OCP 认识到它必须成为催化剂通过投资可实现可组合硅的 Chiplet 互连技术，建立开放和标准化的 Chiplet 生态系统和新市场。BoW 规范的发布是朝这个方向迈出的重要一步。我们希望加大力度开发可组合硅的供应链模型” OCP 基金会首席技术官Bill Carter说。

ODSA BoW PHY 规范针对商品（有机层压板：organic laminate）和先进封装技术进行了优化，可实现成本和能源效率，以及跨各种工艺节点的高性能设计。该规范旨在允许许多用例推动显着的规模经济。注意尽可能少地施加约束，并避免在规范中包含在分解现有 SoC 时可能增加设计复杂性的所需特性。

BoW 规范具有开放许可，可供所有人使用，已在包括三星和 NXP 在内的至少 10 家公司中使用，跨越 5、6、12、16、22 和 65nm 工艺节点的十几个不同用例，并涵盖基于 Chiplet 的网络产品、专用 AI 芯片、FPGA 和处理器。 

“半导体行业通过多核专用 SoC、定制核心架构、深度学习、光通信、模拟处理技术、RF 接口、内存架构等，继续朝着令人兴奋的新方向进行创新。新的挑战是如何集成所有这些不同的创新，其中一些在尖端工艺节点上生产并不实用。今天，OCP ODSA 宣布发布用于 Chiplet 互连的 Bunch of Wires 开源规范，为扩大市场创新提供了新工具。以不同的节奏打开更具竞争性的格局和创新多样性的大门，是燃料或健康的行业，”Yole Intelligence 内存和计算部计算与软件半导体首席分析师Tom Hackenberg说。


公众号内回复**‘Bunch of Wires ’**，即可获取规范文件完整版解读。
...
★[中国大芯片浪潮](https://mp.weixin.qq.com/s?__biz=MzU3OTA0MjQ3Mg==&mid=2247679096&idx=1&sn=fe96e48a137f2478dbced492d79401da&chksm=fd6051bfca17d8a9cad462bf359f5b5abe9ccee7d34efd791ac3492b85664e7d54d007472901&token=420803032&lang=zh_CN&scene=21#wechat_redirect)
★[美国芯片制造行业的黄昏](https://mp.weixin.qq.com/s?__biz=MzU3OTA0MjQ3Mg==&mid=2247678936&idx=1&sn=755799071764d2db079d80a36e64ade7&chksm=fd60561fca17df09bd06aa15d58ec1594e76b5249c05e4bbce025984bb3bae3a12715e2ab04a&token=1206176325&lang=zh_CN&scene=21#wechat_redirect)
★[按下加速键的欧洲半导体](https://mp.weixin.qq.com/s?__biz=MzU3OTA0MjQ3Mg==&mid=2247678654&idx=1&sn=9dbb9a771965f7d937aea6e1483f773a&chksm=fd605779ca17de6f872e2648f0f14979a1566b55c932338a9c04c044a6af813f4dc9640d91fe&token=412931477&lang=zh_CN&scene=21#wechat_redirect)
