...
> 第 **11** 轮 · 2026-09-19 22:58 · 由 `research_evolve.evolve` 生成（每次运行一轮，一轮一次提交）

## 一、闭环四数（判定"进化"还是"空转"的唯一依据）

| 指标 | 本轮 | 上轮 | Δ | 含义 |
|---|---|---|---|---|
| 新增候选 opened | 0 | 5 | -5 | 本轮新进来的问题 |
...
### C-00081 · 🔺升级 score=0.8806 · idea · 挂起 15 天 · 见 11 次
...
### C-00009 · 🔺升级 score=0.8194 · hypothesis · 挂起 27 天 · 见 11 次
...
### C-00123 · 🔺升级 score=0.8194 · idea · 挂起 25 天 · 见 11 次
...
### C-00116 · 🔺升级 score=0.8194 · idea · 挂起 24 天 · 见 11 次
...
### C-00107 · 🔺升级 score=0.8194 · idea · 挂起 21 天 · 见 11 次
...
### C-00101 · 🔺升级 score=0.8194 · idea · 挂起 20 天 · 见 11 次
...
### C-00098 · 🔺升级 score=0.8194 · idea · 挂起 20 天 · 见 11 次
