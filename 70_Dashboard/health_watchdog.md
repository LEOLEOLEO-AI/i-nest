...
**Generated**: 2026-08-31 14:59:05  **Summary**: OK  (CRIT=0 WARN=0)

| Check | Status | Detail |
|---|---|---|
| git_object_store | OK | fsck connectivity clean |
| git_head_reachable | OK | HEAD history walkable (48 commits) |
| git_object_garbage | OK | no stale tmp_pack / orphan idx |
| commit_freshness | OK | last commit 0.4h ago |
| working_tree_backlog | OK | 71 pending change(s) |
| daily_sync | OK | last sync completed 7.4h ago |
| getnotes_pull | OK | last pull 7.4h ago, total=452 |
| pipeline | OK | last run 8.1h ago, new_papers=0 |
| config_llm_config | OK | llm_config.json valid |
| config_model_switch | OK | model_switch.json valid |
| daemons | OK | pythonw=2 node=7 preview8899=True |
