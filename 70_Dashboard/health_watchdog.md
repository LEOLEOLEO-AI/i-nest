...
**Generated**: 2026-09-20 02:59:07  **Summary**: CRITICAL  (CRIT=1 WARN=0)

| Check | Status | Detail |
|---|---|---|
| git_object_store | OK | fsck connectivity clean |
| git_head_reachable | OK | HEAD history walkable (108 commits) |
| git_object_garbage | OK | no stale tmp_pack / orphan idx |
| commit_freshness | OK | last commit 4h ago |
| working_tree_backlog | CRIT | 1702 pending changes (>200, pipeline output likely stuck) |
| github_divergence | OK | 与 github/main 同源; 本地独有 0 / 落后 0 |
| daily_sync | OK | last sync completed 16.1h ago |
| getnotes_pull | OK | last pull 16.2h ago, total=572 |
| pipeline | OK | last run 14.9h ago, new_papers=0 (task last run 09/19/2026 12:00:01, exit=0x0) |
...
| self_evolve_outcome | OK | 4h 前运行 — R11: opened=0 closed=0 escalated=48 gate_new=0 open_total=75 |
