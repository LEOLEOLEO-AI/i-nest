...
**Generated**: 2026-09-21 20:59:08  **Summary**: WARNING  (CRIT=0 WARN=2)

| Check | Status | Detail |
|---|---|---|
| git_object_store | OK | fsck connectivity clean |
| git_head_reachable | OK | HEAD history walkable (113 commits) |
| git_object_garbage | OK | no stale tmp_pack / orphan idx |
| commit_freshness | OK | last commit 15h ago |
| working_tree_backlog | WARN | 92 pending changes (>50, not yet committed/published) |
| github_divergence | OK | 与 github/main 同源; 本地独有 0 / 落后 0 |
| daily_sync | OK | last sync completed 15h ago |
| getnotes_pull | OK | last pull 15h ago, total=583 |
| pipeline | OK | last run 1.1h ago, new_papers=0 (task last run 09/21/2026 13:31:40, exit=0x41306 failed) |
...
| self_evolve_outcome | WARN | 自膨胀告警: 连续 2 轮只新增不关闭 — R14: opened=1 closed=0 escalated=51 gate_new=0 open_total=79 |
