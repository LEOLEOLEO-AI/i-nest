...
**Generated**: 2026-09-19 11:59:34  **Summary**: CRITICAL  (CRIT=1 WARN=1)

| Check | Status | Detail |
|---|---|---|
| git_object_store | OK | fsck connectivity clean |
| git_head_reachable | OK | HEAD history walkable (105 commits) |
| git_object_garbage | OK | no stale tmp_pack / orphan idx |
| commit_freshness | OK | last commit 0.9h ago |
| working_tree_backlog | CRIT | 1581 pending changes (>200, pipeline output likely stuck) |
| github_divergence | OK | 与 github/main 同源; 本地独有 0 / 落后 0 |
| daily_sync | OK | last sync completed 1.1h ago |
| getnotes_pull | OK | last pull 1.2h ago, total=572 |
| pipeline | OK | last run 18.3h ago, new_papers=0 (task last run 09/18/2026 17:30:13, exit=0x0) |
