...
**Generated**: 2026-09-18 22:59:16  **Summary**: CRITICAL  (CRIT=1 WARN=2)

| Check | Status | Detail |
|---|---|---|
| git_object_store | OK | fsck connectivity clean |
| git_head_reachable | OK | HEAD history walkable (100 commits) |
| git_object_garbage | OK | no stale tmp_pack / orphan idx |
| commit_freshness | OK | last commit 11.5h ago |
| working_tree_backlog | CRIT | 6071 pending changes (>200, pipeline output likely stuck) |
| github_divergence | OK | 与 github/main 同源; 本地独有 0 / 落后 0 |
| daily_sync | WARN | 同步已尝试但未完成: last start 1.98310836541667h ago / last done 218h ago — 见 D:\Obsidian\scripts\sync_log.txt |
| getnotes_pull | OK | last pull 2h ago, total=571 |
| pipeline | OK | last run 5.3h ago, new_papers=0 (task last run 09/18/2026 17:30:13, exit=0x0) |
