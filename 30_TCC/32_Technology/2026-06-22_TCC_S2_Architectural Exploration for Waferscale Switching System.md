...
entities:
- waferscale system
- network on wafer (NoW)
- butterfly fat-tree (BFT)
processed: '2026-06-22T08:41:14.643714'
source: S2
source_file: 2026-06-22_TCC_S2_Architectural Exploration for Waferscale Switching
  System.md
summary: 探索晶圆级交换系统的片上网络架构，提出软件方法重定义拓扑属性，构建五层蝶形胖树逻辑结构。
tags:
- from-s2
- tcc
- Switching System
