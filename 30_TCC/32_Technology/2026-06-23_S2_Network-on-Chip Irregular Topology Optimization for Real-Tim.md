---
authors: S. D. S. Oliveira, B. M. Carvalho, M. Kreutz
...
processed: '2026-06-23T12:41:29.131811'
source: S2
source_file: 2026-06-23_S2_Network-on-Chip Irregular Topology Optimization for Real-Tim.md
status: inbox
summary: 提出利用遗传算法优化不规则拓扑的片上网络，以降低平均延迟并确保实时数据包在截止时间内交付。
tags:
- from-s2
- 遗传算法
- auto-crawl
...
- 片上网络
- 不规则拓扑
title: Network-on-Chip Irregular Topology Optimization for Real-Time and Non-Real-Time
  Applications
track: TCC
