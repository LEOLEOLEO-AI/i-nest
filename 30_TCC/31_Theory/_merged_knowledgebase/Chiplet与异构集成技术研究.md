...
[](https://www.zhihu.com/people/tang-shan-13-96)


[唐杉](https://www.zhihu.com/people/tang-shan-13-96)


芯片架构师和技术爱好者


## **Chiplet的概念很火，我之前也写过一篇文章，[从AI Chip到AI Chiplet](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26mid%3D2247484890%26idx%3D1%26sn%3Da9464f059dab39c0f2d77c086ccccd66%26chksm%3Dead1f8cbdda671ddd48789e1636839b930a7466004faa61119c5cfb76bb43f1efa667558f29c%26scene%3D21%23wechat_redirect)，初步的分析它的基本特征，优势，前景和一些挑战。Chiplet的重要性，不仅是给摩尔定律“续命”，也开启了很多新的机会，其前景毋庸置疑。Chiplet虽然是个新词，但其背后更通用的说法：异构集成（Heterogeneous Integration），并不是新概念。从Chiplet到异构集成，涉及内容很多，也非常有意思，值得仔细研究讨论一下。**
...
Chiplet和异构集成有两个大的目标，第一各是提升性能，延续摩尔定律；第二个则强调异构。两个目标侧重点不同，技术挑战和发展路径也不同。本文更多关注的是前者，重点是讨论通过异构集成追求更高性能（面向HPC和数据中心的高端芯片），看看这个方向上异构集成技术会怎么发展。这里异构集成希望解决的问题包括：**Die size limitation**（工艺和良率的限制，Die的面积很难继续增大）；**The Processor-Memory Performance Gap**（传统的架构挑战）；**Exploiting Accelerators for Emerging Applications**（领域专用架构的更多使用）；**Package IO Limitations for future Ethernet Switches and Routers**（I/O瓶颈对系统扩展性的影响） ；**Integration of dies from diverse nodes and technologies**（集成不同工艺节点的Die的需求，典型的包括Compute，Memory，I/O的集成）。
## **International Roadmap for Devices and Systems™**

除了HIR，ITRS还有一个更直接的继任者，International Roadmap for Devices and Systems™。**The [IRDS™](https://link.zhihu.com/?target=https%3A//irds.ieee.org/home/process)is a set of predictions that serves as the successor to the ITRS. The intent is to provide a clear outline to simplify academic, manufacturing, supply, and research coordination regarding the development of electronic devices and systems.
IRDS关注点主要包括下面一些方面
...
- •  IC interconnects
和HIR的重心在于各种各样的集成不同，IRDS更关注摩尔定律失效后整个半导体技术如何发展，从材料到器件，工艺，互连，封装，甚至系统。希望能够通过各个领域的发展延续半导体技术和产业的持续发展。IRDS中也包括先进封装和集成的部分，比如“PACKAGING INTEGRATION WHITE PAPER”，可以作为参考。
HBM集成的实例**
...
在Roofline模型里，“屋脊”的两根线，水平的代表处理器的峰值算力（这里的Processor peak throughput），可以分解为核的数量，核的频率以及每个时钟周期的操作数数量这几个因素；而斜线的高度由存储带宽决定。不同的Workload，由于处理密度（Operational intensity）不同，在图中处于不同位置，但这个“屋脊”是性能上限。由于摩尔定律放缓，功耗的限制，Die Size的限制，在单个Die上提高Roofline已经非常困难（领域专用架构DSA可能抬高Roofline，但同样受到这些限制）。这里的一个例外是Cerebras搞的WSE，感兴趣的可以参考“**[如何设计一颗40PFLOPS量级的AI芯片？](https://link.zhihu.com/?target=http%3A//mp.weixin.qq.com/s%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26mid%3D2247484629%26idx%3D1%26sn%3D8297f335784f63b7010880dc0ca07b28%26chksm%3Dead1f9c4dda670d2652c842aa8555f1d32abc74e9da0a91d812233f9c39034fc3cd7694d0570%26scene%3D21%23wechat_redirect)**”。
...
最后，**如何降低成本**？上述的技术改进虽然能够获得更高的性能和功耗效率，但大部分都增加了实现的难度和流程的复杂度，意味着更高的成本。因此，如何降低成本可能是最技术普及最大的挑战。
## **业界最新进展**

EETimes最近的文章“[AMD, TSMC & Imec Show Their Chiplet Playbooks at ISSCC](https://link.zhihu.com/?target=https%3A//www.eetimes.com/amd-tsmc-imec-show-their-chiplet-playbooks-at-isscc/%23)”，基于ISSCC2021的“Enabling New System Architectures with 2.5, 3D and Chiplet Technologies”论坛，从不同角度分析了业界对Chiplet技术的应用和预期。
其中AMD作为Chiplet技术最早的实践者，取得了非常好的效果。通过对芯片功能的分解和重新组会，得到了更合理的Chiplet集成方式，也为未来扩展开启了新的路径。

说到系统的解构和重组，一下一篇Imec的文章可以参考以下。该文也提出了从DTCO（Design-Technology Co-Optimization）到STCO（System-Technology Co-Optimization）的说法。

[A 3D technology toolbox in support of system-technology co-optimization​www.imec-int.com/en/imec-magazine/imec-magazine-july-2019/a-3d-technology-toolbox-in-support-of-system-technology-co-optimization](https://link.zhihu.com/?target=https%3A//www.imec-int.com/en/imec-magazine/imec-magazine-july-2019/a-3d-technology-toolbox-in-support-of-system-technology-co-optimization)
TSMC是foundry的代表，也是目前最先进的技术提供者，基本上未来所有的潜在技术的发展和各种组会都在其手中，当然对未来也是雄心勃勃。

Imec作为传统的底层技术提供者，一个主要的研究方向就是3D集成。根据前面的分析，集成技术中重要的瓶颈问题就是**如何提升互连密度**。从Imec的视角，这个问题聚焦在三个关键技术：Through-silicon-via (TSV)，Die-to-die, die-to-wafer stacking & interconnect，Wafer-to-wafer bonding & interconnect technology。
...
这个例子来自Intel Cap投资的Ayar Lab，正好也用到了本文前面讲的2.5D Chiplet的技术。左图是概念图，下面绿色的就是Package Substrate，中间是一个FPGA Die，边上Die是光I/O的Phy（TeraPHY）。FPGA Die和TeraPHY就是通过Intel的EMIB模式连接的（没有额外的Interposer）。右边就是最终的封装外形，可以看到，正是把光I/O放到封装里。下图正好可以体会一下EMBI的Substrate。
...
[6] [http://www.3dincites.com](https://link.zhihu.com/?target=http%3A//www.3dincites.com)
[7] [https://en.wikipedia.org/wiki/Three-dimensional_integrated_circuit...](https://link.zhihu.com/?target=https%3A//en.wikipedia.org/wiki/Three-dimensional_integrated_circuit)
[8] 胡承維，"CoWoS ＆ Fan-Out Process Flow"

**相关公众号专题：**
**[人工智能芯片技术基础](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1374108991751782402%26token%3D825417533%26lang%3Dzh_CN%23wechat_redirect)**
**[人工智能芯片技术进步](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1374097412805165056%26token%3D825417533%26lang%3Dzh_CN%23wechat_redirect)**
**[人工智能芯片产业发展](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1374089812021673988%23wechat_redirect)**
**[人工智能芯片初创公司](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1600178502002098179%26token%3D825417533%26lang%3Dzh_CN%23wechat_redirect)**
**[人工智能芯片评测对比](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1600208703943688199%26token%3D825417533%26lang%3Dzh_CN%23wechat_redirect)**
**[科技巨头的芯片尝试](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1600213438406934529%26token%3D825417533%26lang%3Dzh_CN%23wechat_redirect)**
**[从学术会议看人工智能芯片](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1600183908778721281%23wechat_redirect)**
**[基础芯片技术](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/mp/appmsgalbum%3F__biz%3DMzI3MDQ2MjA3OA%3D%3D%26action%3Dgetalbum%26album_id%3D1678711252069466118%23wechat_redirect)**
题图来自网络，版权归原作者所有
本文为个人兴趣之作，仅代表本人观点，与就职单位无关
发布于 2021-03-12 12:23
...
半导体行业](https://www.zhihu.com/topic/20775821)
[
