...
class SDI_LTC:
    ...
    def _stim_seeds(self):
        """结构化刺激：每 T_STIM ms 触发一次，等待雪崩熄灭"""
        stim_interval = int(T_STIM / DT)  # 步数
...
def main():
    ...
    def fix(o):
        ...
        return o
    with open(f'{OUT}/exp1_v12b_results.json','w') as f:
    ...
    plt.tight_layout()
    plt.savefig(f'{OUT}/exp1_v12b_convergence.png',dpi=130,bbox_inches='tight')
    plt.close()
    print(f'Results → exp1_v12b_results.json')
    print(f'Plot → exp1_v12b_convergence.png')
    print('DONE')
