#!/usr/bin/env python3
"""
SDI 实验五 v12：稳态权重归一化（Turrigiano 2012）+ 软饱和STDP + 双重G校准
...
def plot_results(all_results):
    ...
    plt.savefig(f'{OUT}/exp5_v12_avalanche_results.png', dpi=150, bbox_inches='tight')
    plt.close()
    print(f"Figure: {OUT}/exp5_v12_avalanche_results.png")
...
def main():
    ...
    out_path = f'{OUT}/exp5_v12_avalanche_results.json'
