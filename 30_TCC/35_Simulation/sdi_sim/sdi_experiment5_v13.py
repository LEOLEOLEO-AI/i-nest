...
def plot_results(all_results):
    ...
    plt.savefig(f'{OUT}/exp5_v13_avalanche_results.png', dpi=150, bbox_inches='tight')
    plt.close()
    print(f"Figure: {OUT}/exp5_v13_avalanche_results.png")
...
def main():
    ...
    out_path = f'{OUT}/exp5_v13_avalanche_results.json'
