...
- marketplace.json
- PowerShell
processed: '2026-06-06T10:44:45.445717'
score: 6
source: GetNotes
source_file: GetNote_20260606_100554_getnote_1911801009156485824_Codex更新后Computer
  Use-Chrome插件消失问题深度解决方案.md
summary: 解决微软商店版Codex更新后插件消失的方法，含命令行修复。
tags:
- inest
- tech-clip
- Computer Use
