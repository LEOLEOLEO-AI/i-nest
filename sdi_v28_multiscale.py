...
# ============================================================
# v27 Core Simulator (from v26 + BCM_ETA=0.25)
# ============================================================
...
def v27_multi_scale_test(factors=[1, 2, 3, 4, 7], n_steps=300):
    print("=" * 70)
    print("v28 Real C.elegans xN Multi-Scale Test")
    print(f"  Scales: x{factors} = {[279*f for f in factors]}")
    print(f"  BCM_ETA=0.25 | Degree scaling epsilon=0.14")
    print("=" * 70)
    ...
    # Save
    with open(f"{OUT_DIR}/v28_results.json", "w") as f:
