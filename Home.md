...
> **知识库状态：活跃** | 管线：⚠️ paused | Git: 3200 uncommitted | 更新：2026-08-07 03:07
...
| 维度 | 数值 | 变化 |
|---|---|---|
| 🏷️ 概念总数 | **3124** | TCC=793, iNEST=1068, Cross=1263 |
| 📝 编译文章 | **789** | raw/ → wiki/articles/ |
| 🌉 跨域桥梁 | **3** | 强度 509/388/308 |
...
| # | 桥梁 | 强度 | 核心洞察 |
|---|---|---|---|
| 1 | **SDI × Plastic × Interconnect** | 509 | SDI's software-defined interconnect could implement plastic (reconfigurable) net |
| 2 | **Chiplet × Heterogeneous × Neuromorphic** | 388 | Chiplet-based heterogeneous integration enables combining CMOS logic with memris |
| 3 | **NoC × Spiking × Routing** | 308 | NoC routing algorithms could be redesigned for event-driven spike packet deliver |
...
入口：[[30_TCC/TCC_Master_Index|TCC 主索引]] · [[wiki/index#TCC — Topology-Centric Computing (793 concepts)|TCC Wiki (793 概念)]]
...
入口：[[40_iNEST/iNEST_Master_Index|iNEST 主索引]] · [[wiki/index#iNEST — In-Network Neuromorphic (1068 concepts)|iNEST Wiki (1068 概念)]]
...
论文导入 → Inbox → 管线筛选 → raw/
    ↓
wiki_compiler → wiki/ (3124 概念, 789 文章)
    ↓
跨域洞察 + 任务推荐 + 假设验证
    ↓
每日行动 → 实验/写作/专利任务
...
| [[wiki/index\|Wiki 概念索引]] | 3124 个结构化概念 |
...
- 真正断链：**2105**  ·  孤儿笔记：**2432**  ·  缺 frontmatter：**219**
...
*主页由 homepage_generator.py 自动刷新 | 2026-08-07 03:07*
