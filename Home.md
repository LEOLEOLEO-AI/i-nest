...
> **知识库状态：活跃** | 管线：⚠️ paused | Git: 564 uncommitted | 更新：2026-08-04 07:15
...
| 维度 | 数值 | 变化 |
|---|---|---|
| 🏷️ 概念总数 | **387** | TCC=155, iNEST=86, Cross=146 |
| 📝 编译文章 | **67** | raw/ → wiki/articles/ |
| 🌉 跨域桥梁 | **3** | 强度 80/79/53 |
...
| # | 桥梁 | 强度 | 核心洞察 |
|---|---|---|---|
| 1 | **Chiplet × Heterogeneous × Neuromorphic** | 80 | Chiplet-based heterogeneous integration enables combining CMOS logic with memris |
| 2 | **WaferScale × Neuromorphic** | 79 | Wafer-scale integration could enable massive-scale neuromorphic chips with milli |
| 3 | **SDI × Plastic × Interconnect** | 53 | SDI's software-defined interconnect could implement plastic (reconfigurable) net |
...
入口：[[30_TCC/TCC_Master_Index|TCC 主索引]] · [[wiki/index#TCC — Topology-Centric Computing (155 concepts)|TCC Wiki (155 概念)]]
...
入口：[[40_iNEST/iNEST_Master_Index|iNEST 主索引]] · [[wiki/index#iNEST — In-Network Neuromorphic (86 concepts)|iNEST Wiki (86 概念)]]
...
论文导入 → Inbox → 管线筛选 → raw/
    ↓
wiki_compiler → wiki/ (387 概念, 67 文章)
    ↓
跨域洞察 + 任务推荐 + 假设验证
    ↓
每日行动 → 实验/写作/专利任务
...
| [[wiki/index\|Wiki 概念索引]] | 387 个结构化概念 |
...
*主页由 homepage_generator.py 自动刷新 | 2026-08-04 07:15*
