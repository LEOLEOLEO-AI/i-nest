...
> **知识库状态：活跃** | 管线：❓ unknown | Git: 5883 uncommitted | 更新：2026-09-02 04:10
...
| 维度 | 数值 | 入口 |
|---|---|---|
| 📄 知识库总文件 | **12,373** | [[Home\|根目录/Home]] |
| 🔬 TCC 资料 | **1,851** | [[30_TCC/TCC_Master_Index\|TCC 主索引]] |
| 🧠 iNEST 资料 | **1,264** | [[40_iNEST/iNEST_Master_Index\|iNEST 主索引]] |
| 📥 待处理论文 | **556** | [[00_Inbox/_pipeline_insights/Index\|论文收件箱]] |
| ⚙️ 处理中 | **563** | [[20_Processing\|处理区]] |
| 📤 成果区 | **430** | [[50_Output\|50_Output 成果区]] |
...
| 维度 | 数值 | 变化 |
|---|---|---|
| 🏷️ 概念总数 | **5583** | TCC=1460, iNEST=1908, Cross=2215 |
| 📝 编译文章 | **1198** | raw/ → wiki/articles/ |
| 🌉 跨域桥梁 | **3** | 强度 1091/928/719 |
...
| # | 桥梁 | 强度 | 核心洞察 |
|---|---|---|---|
| 1 | **SDI × Plastic × Interconnect** | 1091 | SDI's software-defined interconnect could implement plastic (reconfigurable) net |
| 2 | **Chiplet × Heterogeneous × Neuromorphic** | 928 | Chiplet-based heterogeneous integration enables combining CMOS logic with memris |
| 3 | **NoC × Spiking × Routing** | 719 | NoC routing algorithms could be redesigned for event-driven spike packet deliver |
...
入口：[[30_TCC/TCC_Master_Index|TCC 主索引]] · [[wiki/index#TCC — Topology-Centric Computing (1460 concepts)|TCC Wiki (1460 概念)]]
...
入口：[[40_iNEST/iNEST_Master_Index|iNEST 主索引]] · [[wiki/index#iNEST — In-Network Neuromorphic (1908 concepts)|iNEST Wiki (1908 概念)]]
...
论文导入 → Inbox → 管线筛选 → raw/
    ↓
wiki_compiler → wiki/ (5583 概念, 1198 文章)
    ↓
跨域洞察 + 任务推荐 + 假设验证
    ↓
每日行动 → 实验/写作/专利任务
...
| [[wiki/index\|Wiki 概念索引]] | 5583 个结构化概念 |
...
- 真正断链：**2037**  ·  孤儿笔记：**2625**  ·  缺 frontmatter：**355**
...
*主页由 homepage_generator.py 自动刷新 | 2026-09-02 04:10*
