...
## Definition
Graph neural networks that incorporate symmetry constraints, ensuring their outputs transform predictably under group actions on the input graph structure. Enables topology-aware processing that respects the inherent symmetries of network topologies, critical for robust in-network computation and neuromorphic mapping.
...
## Merged From
- EquivariantGraphNeuralNetworks (merged 2026-08-23)
