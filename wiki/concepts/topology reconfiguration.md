...
> 由 self_evolve 自动生成的占位概念（被引用 18 次，来源尚未成稿）。
...
- [[Complete Physical Topology Mapping for Collective Communication Primitives A CST-Optimal Framework for Network-Centric C (2)]]
- [[P-Theory_v2_MetaTopology_SDI_Bond_Draft]]
- [[20260405_基于元拓扑与SDI化合键的通信原语生成理论]]
