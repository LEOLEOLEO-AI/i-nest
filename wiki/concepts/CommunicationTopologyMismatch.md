---
title: "CommunicationTopologyMismatch"
type: concept
domain: TCC
created: 2026-08-10
auto: true
...
## Definition
The phenomenon where the logical communication pattern of transformer inference (e.g., all-to-all in attention) does not match the physical network topology, causing bottlenecks. Identifying and resolving this mismatch is a core TCC research problem, as it directly impacts scalability and efficiency of distributed transformer inference.
