...
2. $\eta$_I values corrected: human $\eta$_I 0.18$\rightarrow$3.67; GPT-4 $\eta$_I 4$\times$10⁻⁷$\rightarrow$8.8$\times$10⁻⁶ (per formula $\eta$_I=CST/\$1_{norm}\$; five-order-of-magnitude gap confirmed at 4.2$\times$10⁵)
