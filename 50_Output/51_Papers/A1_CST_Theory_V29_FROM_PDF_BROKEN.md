...
3. Results §3.2: Updated cohort description: "8 BNN + 8 ANN" → "20 BNN spanning 8 taxonomic grades + 20 ANN/NMH representing 18 distinct architectural families". Updated Fisher test p-values (n=40 stronger statistical power): $α$ = $1/√2$ (p=0.0003, $α$ = $φ$ p=0.0004, $α$ = $π$ p=0.0001.
