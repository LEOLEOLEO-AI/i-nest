---
authors: Ambuj, R. Machavaram
category: AI-ML
date: 2026-06-23
entities:
- 脉冲神经网络
- 基于内容的图像检索
processed: '2026-06-23T12:41:51.513634'
source: S2
source_file: 2026-06-23_S2_Neuromorphic computing spiking neural network edge detection.md
status: inbox
summary: 提出一种基于脉冲神经网络的边缘检测方法，用于内容图像检索，计算开销降低2.5倍。
tags:
- from-s2
- inest
- auto-crawl
...
- 脉冲神经网络
- 边缘检测
title: Neuromorphic computing spiking neural network edge detection model for content
...
**Authors**: Ambuj, R. Machavaram | **Year**: 2024
**URL**: [https://www.semanticscholar.org/paper/4f3381a44fe663365bd63ec540bdf4511ac562d9](https://www.semanticscholar.org/paper/4f3381a44fe663365bd63ec540bdf4511ac562d9)
