"""
SDI V31 - Multi-Brain Cooperation & Collective Intelligence Simulation
======================================================================
Based on V30 single-brain multi-region architecture.
Each brain has vis/chem/assoc/motor regions.
Brains interact via shared environment and inter-brain SDI bonds.

Experiments:
  2-1: Dual-brain resource competition
...
class BrainRegion:
    ...
    def __init__(self, name, N, p_connect=0.08):
        self.name = name
        self.N = N
    ...
    def step(self, step_num, external_input=None):
        ...
        if step_num % 20 == 0: self._fep_update(step_num)
...
# ============================================================
class Brain:
    """Complete brain with vis+chem+assoc+motor regions and cross-region connections."""

    def __init__(self, brain_id, region_sizes=None):
        ...
        for rname, rsize in sizes.items():
            self.regions[rname] = BrainRegion(rname, rsize)
...
class MultiBrainSimulation:
    ...
    def __init__(self, n_brains=2, region_sizes=None, env_width=100.0, env_height=100.0):
        self.brains = {}
        self.brain_positions = {}
        for i in range(n_brains):
            bid = 'brain_' + str(i)
            self.brains[bid] = Brain(bid, region_sizes)
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("SDI V31 - Multi-Brain Cooperation Experiments")
    print("="*60)
    t_start = time.time()
