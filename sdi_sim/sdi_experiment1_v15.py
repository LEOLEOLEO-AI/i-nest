...
方案C：BA 无标度初始图（Scale-Free，hub 结构）
  ...
  - 完全随机，不预设任何生物拓扑
延长：T_SIM = 30000ms（30秒），仿真约375次刺激
"""
...
T_STIM   = 80.0   # ms
T_BIN    = 4.0    # ms
T_SIM    = 30000.0  # ms（方案延长：30秒）

# ======== SDI 参数 ========
THETA_LTP = 40     # 降低阈值，加快固化速度
THETA_LTD = 10
T_DECAY_MS = 4000.0
EL_HI      = 0.25
MAX_FIX    = 10
