# -*- coding: utf-8 -*-
"""Generate the corrected TCC x iNEST R&D Kanban HTML."""
import json

OUT = r"D:\Obsidian\home\work\.openclaw\workspace\dashboard\index.html"

# ═══════════════════════════════════════════════════════
# DATA - real project content
# ═══════════════════════════════════════════════════════
DAILY = [
  {
    "date":"2026-06-05","type":"today",
    "progress":[
      {"text":"SDI v30 多区域拓扑网络（multi-region）架构设计与初始仿真","dot":"ongoing","dim":"TCC"},
      {"text":"拓扑中心计算范式理论框架进一步细化","dot":"ongoing","dim":"TCC"},
      {"text":"看板迭代：修正TCC/iNEST命名体系，修复交互Bug","dot":"done","dim":"TCC+iNEST"},
    ],
    "plan":[
      {"text":"SDI v30 多区域跨尺度耦合验证实验","dot":"plan","dim":"TCC"},
      {"text":"FEP-STDP 收敛性证明数学推导完成","dot":"plan","dim":"iNEST"},
      {"text":"核心架构论文 Results 章节撰写","dot":"plan","dim":"iNEST"},
    ]
  },
  {
    "date":"2026-06-04","type":"yesterday",
    "progress":[
      {"text":"SDI v30 多区域拓扑仿真框架搭建完成","dot":"done","dim":"TCC"},
      {"text":"SDI v29 功能性涌现模块集成测试，PASS率 94.2%","dot":"done","dim":"iNEST"},
      {"text":"iNEST 核心架构论文 Methods 章节定稿","dot":"done","dim":"iNEST"},
    ],
    "plan":[
      {"text":"SDI v30 多区域耦合验证","dot":"done","dim":"TCC"},
      {"text":"专利组合文档 v2.1 更新","dot":"ongoing","dim":"TCC+iNEST"},
    ]
  },
  {
    "date":"2026-06-03","type":"past",
    "progress":[
      {"text":"SDI v8-v28 版本批量回归测试与性能对比","dot":"done","dim":"iNEST"},
      {"text":"FPGA Verilog 代码：sdio_bond_core_v24 模块实现","dot":"done","dim":"iNEST"},
      {"text":"iNEST 爬虫系统更新，知识采集管线优化","dot":"done","dim":"iNEST"},
      {"text":"液态计算化学论文 draft-v2 迭代","dot":"done","dim":"iNEST"},
      {"text":"投资人演示 Demo v3 站点构建与部署","dot":"done","dim":"iNEST"},
    ],
    "plan":[]
  },
  {
    "date":"2026-06-02","type":"past",
    "progress":[
      {"text":"SDI v27->v28 多尺度融合框架实现完成","dot":"done","dim":"iNEST"},
...
ENTRIES = [
  # ═══ TCC · 拓扑中心计算 ═══
  # ── 灵感 ──
  {"id":1,"dim":"TCC","cat":"灵感","title":"从节点中心到拓扑中心：计算范式根本转变的理论框架","ver":"v2.0","status":"进行中","date":"2026-06-05","desc":"提出将计算的基本单元从单个节点提升至网络拓扑结构本身，以拓扑不变量（Betti数、持续同调等）作为计算原语，实现拓扑原生计算","priority":"高"},
  ...
  {"id":3,"dim":"TCC","cat":"灵感","title":"拓扑中心视角下的复杂网络路由优化","ver":"v1.0","status":"进行中","date":"2026-05-30","desc":"以网络全局拓扑结构（非单节点策略）驱动路由决策，融合小世界与无标度特性","priority":"高"},

  # ── 论文 ──
  {"id":4,"dim":"TCC","cat":"论文","title":"Topology-Centric Computing: A Paradigm Shift from Nodes to Networks","ver":"draft-v1","status":"撰写中","date":"2026-06-05","desc":"TCC范式宣言论文：论证拓扑中心计算的数学基础、计算模型与相对于节点中心范式的理论优势","priority":"高"},
  {"id":5,"dim":"TCC","cat":"论文","title":"Persistent Homology as a Computational Primitive for Network Intelligence","ver":"outline","status":"规划中","date":"2026-05-28","desc":"将持续同调理论引入网络计算，以拓扑不变量作为原生计算操作","priority":"中"},

  # ── 专利 ──
  {"id":6,"dim":"TCC","cat":"专利","title":"一种基于网络拓扑不变量的分布式计算方法","ver":"构思-v2","status":"撰写中","date":"2026-06-04","desc":"利用拓扑不变量（Betti数、Euler示性数）作为分布式计算原语，突破节点中心范式","priority":"高"},
  {"id":7,"dim":"TCC","cat":"专利","title":"多区域拓扑网络的自适应耦合系统","ver":"构思-v1","status":"规划中","date":"2026-06-01","desc":"基于SDI v30 multi-region架构的多区域拓扑自适应耦合方法","priority":"中"},

  # ── 仿真 ──
  {"id":8,"dim":"TCC","cat":"仿真程序","title":"SDI v30 多区域拓扑仿真","ver":"v30","status":"测试中","date":"2026-06-04","desc":"最新版SDI，实现多区域拓扑网络的跨尺度耦合与区域间涌现交互","priority":"高","link":"phase1_workspace/sdi_v30_multiregion.py"},
  {"id":9,"dim":"TCC","cat":"仿真程序","title":"拓扑不变量计算与可视化工具","ver":"v0.2","status":"规划中","date":"2026-05-25","desc":"基于持续同调的网络拓扑特征提取与可视化工具","priority":"中"},

  # ── 产品代码 ──
  {"id":10,"dim":"TCC","cat":"产品代码开发","title":"TCC 拓扑中心计算引擎 (Python)","ver":"v0.3-dev","status":"开发中","date":"2026-06-05","desc":"拓扑中心计算核心引擎，将网络拓扑结构作为一等计算对象","priority":"高"},
  {"id":11,"dim":"TCC","cat":"产品代码开发","title":"FPGA 拓扑加速模块 (Verilog)","ver":"v0.1-prototype","status":"开发中","date":"2026-06-03","desc":"SDI关键路径的FPGA硬件加速原型，含sdio_bond_core_v24","priority":"高","link":"phase1_workspace/iNEST_4_工程开发/fpga"},

  # ── 项目指南 ──
  {"id":12,"dim":"TCC","cat":"项目指南策划","title":"TCC 拓扑中心计算技术白皮书","ver":"大纲-v1","status":"规划中","date":"2026-06-04","desc":"全面阐述拓扑中心计算范式：理论基础、计算模型、工程实现与产业前景","priority":"高"},
  {"id":13,"dim":"TCC","cat":"项目指南策划","title":"拓扑中心计算入门指南","ver":"v0.1","status":"规划中","date":"2026-05-20","desc":"面向新成员的TCC范式入门：从图论、代数拓扑到SDI框架","priority":"中"},

  # ═══ iNEST · 复杂网络涌现智能 ═══
  # ── 灵感 ──
  {"id":14,"dim":"iNEST","cat":"灵感","title":"FEP自由能原理驱动的网络功能涌现临界条件","ver":"v2.1","status":"验证中","date":"2026-06-04","desc":"探索FEP自由能最小化与网络临界相变的数学联系，寻找涌现智能的相变边界","priority":"高"},
  {"id":15,"dim":"iNEST","cat":"灵感","title":"SDI框架下的多尺度拓扑自组织机制","ver":"v1.8","status":"进行中","date":"2026-06-03","desc":"研究微观-介观-宏观三层网络中自组织拓扑的形成与演化规律","priority":"高"},
  {"id":16,"dim":"iNEST","cat":"灵感","title":"忆阻器交叉阵列与SDI拓扑的硬件映射","ver":"v0.8","status":"探索中","date":"2026-05-22","desc":"将SDI网络拓扑结构映射到忆阻器交叉阵列的可行性研究","priority":"中"},

  # ── 论文 ──
  {"id":17,"dim":"iNEST","cat":"论文","title":"iNEST: Complex Network Emergent Intelligence via Self-organizing Topology","ver":"draft-v4","status":"撰写中","date":"2026-06-04","desc":"iNEST核心架构论文，含FEP-STDP融合框架与功能涌现机制","priority":"高","link":"phase1_workspace/papers/paper1_iNEST_core_architecture.md"},
  {"id":18,"dim":"iNEST","cat":"论文","title":"Liquid Computing Chemistry: FEP-driven Self-organization in Artificial Neural Substrates","ver":"draft-v2","status":"撰写中","date":"2026-06-03","desc":"液态计算化学：FEP驱动的人工神经基质自组织与涌现","priority":"高","link":"phase1_workspace/papers/paper2_liquid_computing_chemistry.md"},
  {"id":19,"dim":"iNEST","cat":"论文","title":"类脑计算最新综述与iNEST定位分析","ver":"outline","status":"资料整理","date":"2026-05-22","desc":"基于Nature Electronics综述，梳理iNEST在类脑计算与涌现智能领域的定位","priority":"中","link":"GetNotes_Inbox/_processed/类脑计算最新综述.md"},
  {"id":20,"dim":"iNEST","cat":"论文","title":"算力网络拓扑趋势与iNEST架构对比分析","ver":"notes","status":"资料整理","date":"2026-05-28","desc":"基于CXL 3.0等算力网络趋势，分析iNEST拓扑中心架构的差异化优势","priority":"中","link":"GetNotes_Inbox/_processed/芯片算力网络趋势.md"},

  # ── 专利 ──
  {"id":21,"dim":"iNEST","cat":"专利","title":"专利组合详细方案（6项核心专利）","ver":"v2.1","status":"撰写中","date":"2026-06-03","desc":"含FEP-STDP融合、功能涌现检测、多尺度拓扑优化、多区域耦合等6项核心专利","priority":"高","link":"phase1_workspace/patents/patent_portfolio_detailed.md"},
  {"id":22,"dim":"iNEST","cat":"专利","title":"一种基于自由能原理的自组织网络拓扑优化方法","ver":"申请稿-v1","status":"撰写中","date":"2026-05-20","desc":"FEP驱动的网络拓扑自适应优化方法","priority":"高"},
  {"id":23,"dim":"iNEST","cat":"专利","title":"神经网络功能涌现检测与量化方法","ver":"构思-v1","status":"规划中","date":"2026-06-01","desc":"基于信息论与拓扑指标的神经网络功能涌现自动检测","priority":"中"},

  # ── 仿真 ──
  {"id":24,"dim":"iNEST","cat":"仿真程序","title":"SDI v29 功能性涌现仿真","ver":"v29","status":"已完成","date":"2026-06-04","desc":"功能性涌现模块集成，含自组织临界检测与涌现度量，PASS率94.2%","priority":"高","link":"phase1_workspace/sdi_v29_functional.py"},
  {"id":25,"dim":"iNEST","cat":"仿真程序","title":"SDI v28 多尺度融合仿真","ver":"v28","status":"已完成","date":"2026-06-02","desc":"微观-介观-宏观三层多尺度网络融合框架","priority":"高","link":"phase1_workspace/sdi_v28_multiscale.py"},
  {"id":26,"dim":"iNEST","cat":"仿真程序","title":"SDI v27 多尺度仿真","ver":"v27","status":"已完成","date":"2026-05-28","desc":"初版多尺度网络仿真","priority":"中","link":"phase1_workspace/sdi_v27_multiscale.py"},
  {"id":27,"dim":"iNEST","cat":"仿真程序","title":"SDI v26 多尺度仿真","ver":"v26","status":"已完成","date":"2026-05-20","desc":"多尺度仿真框架初步实现","priority":"中","link":"phase1_workspace/sdi_v26_multiscale.py"},
  {"id":28,"dim":"iNEST","cat":"仿真程序","title":"SDI v25 物理-生物融合","ver":"v25","status":"已完成","date":"2026-05-15","desc":"物理约束与生物启发机制的融合仿真","priority":"中","link":"phase1_workspace/sdi_v25_physical_biological.py"},
  {"id":29,"dim":"iNEST","cat":"仿真程序","title":"SDI v24 FEP-STDP融合仿真","ver":"v24","status":"已完成","date":"2026-05-10","desc":"FEP自由能原理与STDP脉冲时间依赖可塑性的首次融合","priority":"高","link":"phase1_workspace/sdi_v24_fep_stdp_fusion.py"},
  {"id":30,"dim":"iNEST","cat":"仿真程序","title":"SDI v11 FEP进化仿真","ver":"v11","status":"已完成","date":"2026-05-01","desc":"改进版FEP驱动的网络进化仿真","priority":"中","link":"phase1_workspace/sdi_v11_fep_improved.py"},
  {"id":31,"dim":"iNEST","cat":"仿真程序","title":"SDI 相变扫描分析","ver":"v1","status":"已完成","date":"2026-05-01","desc":"网络拓扑相变的参数空间扫描与临界点检测","priority":"中","link":"phase1_workspace/sdi_phase_transition_scan.py"},

  # ── 产品代码 ──
  {"id":32,"dim":"iNEST","cat":"产品代码开发","title":"iNEST 核心网络引擎 (Python)","ver":"v0.6-dev","status":"开发中","date":"2026-06-04","desc":"SDI核心算法的工程化实现，支持大规模复杂网络的拓扑分析与涌现检测","priority":"高"},
  {"id":33,"dim":"iNEST","cat":"产品代码开发","title":"FPGA 硬件加速模块 (Verilog)","ver":"v0.1-prototype","status":"开发中","date":"2026-06-03","desc":"SDI关键路径硬件加速：sdio_bond_core_v24 及其测试平台","priority":"高","link":"phase1_workspace/iNEST_4_工程开发"},
  {"id":34,"dim":"iNEST","cat":"产品代码开发","title":"投资者演示 Demo v3","ver":"v3.0","status":"已完成","date":"2026-06-03","desc":"面向投资人的交互式产品演示站点","priority":"高","link":"phase1_workspace/investor_demo/index.html"},
  {"id":35,"dim":"iNEST","cat":"产品代码开发","title":"iNEST 知识采集爬虫","ver":"v1.2","status":"已完成","date":"2026-06-03","desc":"自动化文献与资讯采集管线，支持论文、专利、技术新闻的多源汇聚","priority":"中","link":"scripts/iNEST_crawler.py"},

  # ── 项目指南 ──
  {"id":36,"dim":"iNEST","cat":"项目指南策划","title":"iNEST 复杂网络涌现智能技术白皮书","ver":"v1.2","status":"持续更新","date":"2026-06-05","desc":"iNEST整体技术体系：拓扑中心计算范式、FEP-STDP融合、SDI框架、应用场景","priority":"高"},
  {"id":37,"dim":"iNEST","cat":"项目指南策划","title":"iNEST CS团队协作指南","ver":"v1.0","status":"已发布","date":"2026-06-03","desc":"团队协作规范、开发流程、知识管理与工具链","priority":"高","link":"iNEST_CS团队指南.pdf"},
  {"id":38,"dim":"iNEST","cat":"项目指南策划","title":"iNEST 对外合作介绍","ver":"v2.0","status":"已发布","date":"2026-06-02","desc":"面向合作伙伴与投资人的项目介绍与技术能力展示","priority":"高","link":"iNEST对外合作介绍材料.html"},
  {"id":39,"dim":"iNEST","cat":"项目指南策划","title":"研发路线图与里程碑规划 (Q3-Q4)","ver":"v1.5","status":"持续更新","date":"2026-06-01","desc":"Q3-Q4研发里程碑、资源分配、风险评估与应对预案","priority":"高"},
]

default_data = {"daily": DAILY, "entries": ENTRIES}
print(f"Data: {len(ENTRIES)} entries, {len(DAILY)} daily records")

# ═══════════════════════════════════════════════════════
# CSS
# ═══════════════════════════════════════════════════════
CSS = """/* TCC x iNEST R&D Kanban v2 */
...
.header{position:sticky;top:0;z-index:100;background:rgba(17,24,39,0.85);backdrop-filter:blur(20px);border-bottom:1px solid var(--border);padding:14px 28px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap}
...
.header h1{font-size:1.15em;font-weight:600;letter-spacing:-0.3px}
...
.header-date{font-size:0.82em;color:var(--text-dim)}
.header-tagline{font-size:0.7em;color:var(--text-dim);opacity:0.7;font-style:italic}
.main{max-width:1640px;margin:0 auto;padding:24px 28px;position:relative;z-index:1}
...
.metric .lbl{font-size:0.73em;color:var(--text-dim);text-transform:uppercase;letter-spacing:0.5px}
...
.daily-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(380px,1fr));gap:14px;margin-bottom:8px}
...
.kanban-col{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:12px;min-height:160px}
...
.card-tag{font-size:0.7em;padding:2px 8px;border-radius:4px;font-weight:500;white-space:nowrap}
...
.filter-chip{padding:6px 14px;border-radius:20px;font-size:0.78em;border:1px solid var(--border);background:var(--surface);color:var(--text-dim);cursor:pointer;transition:var(--transition);font-family:inherit;white-space:nowrap;user-select:none}
...
.index-table td{padding:11px 16px;border-bottom:1px solid rgba(255,255,255,0.03);vertical-align:middle}
.index-table tbody tr{transition:var(--transition)}
...
.ver-link{color:var(--tcc);text-decoration:underline;cursor:pointer;font-weight:500;transition:var(--transition)}
.ver-link:hover{color:#7dd3fc}
...
.btn-sm{background:none;border:1px solid var(--border);padding:4px 10px;border-radius:6px;cursor:pointer;font-size:0.8em;font-family:inherit;transition:var(--transition);white-space:nowrap}
.btn-sm:hover{border-color:rgba(255,255,255,0.3)}
.btn-sm.info{color:var(--tcc);border-color:rgba(56,189,248,0.3)}
.btn-sm.info:hover{background:rgba(56,189,248,0.1)}
.btn-sm.danger{color:var(--danger);border-color:rgba(248,113,113,0.3)}
.btn-sm.danger:hover{background:rgba(248,113,113,0.1)}
.btn-sm.edit{color:var(--warn);border-color:rgba(251,191,36,0.3)}
.btn-sm.edit:hover{background:rgba(251,191,36,0.1)}
...
.modal{background:var(--surface);border:1px solid var(--border);border-radius:14px;padding:28px;max-width:580px;width:92%;max-height:82vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.5);position:relative}
.modal h3{font-size:1.1em;margin-bottom:8px;padding-right:30px}
.modal .close-btn{position:absolute;top:14px;right:18px;background:none;border:none;color:var(--text-dim);font-size:1.3em;cursor:pointer;transition:var(--transition)}
...
.modal-link{color:var(--tcc);text-decoration:underline;cursor:pointer;font-weight:500}
.modal-link:hover{color:#7dd3fc}
.form-input{width:100%;background:var(--surface2);border:1px solid var(--border);color:var(--text);padding:8px 10px;border-radius:6px;font-family:inherit;font-size:0.9em}
.form-input:focus{outline:none;border-color:var(--tcc);box-shadow:0 0 0 2px var(--tcc-glow)}
...
.paradigm-banner{background:linear-gradient(135deg,rgba(56,189,248,0.08),rgba(74,222,128,0.06));border:1px solid var(--border);border-radius:var(--radius);padding:14px 20px;margin-bottom:18px;font-size:0.85em;color:var(--text-dim);text-align:center}
.paradigm-banner strong{color:var(--tcc)}
.paradigm-banner em{color:var(--inest);font-style:normal}
@media(max-width:1200px){.kanban-dual{grid-template-columns:1fr}}
@media(max-width:768px){.kanban-grid{grid-template-columns:1fr 1fr}.daily-grid{grid-template-columns:1fr}.header{padding:10px 14px}.main{padding:14px}.metrics{grid-template-columns:repeat(auto-fit,minmax(120px,1fr))}}
"""

print(f"CSS: {len(CSS)} chars")

# ═══════════════════════════════════════════════════════
# JAVASCRIPT - with all bug fixes
# ═══════════════════════════════════════════════════════
JS = r"""
var CATS=["灵感","论文","专利","仿真程序","产品代码开发","项目指南策划"];
var DIMS=["TCC","iNEST"];
var STATUSES=["规划中","进行中","撰写中","开发中","测试中","验证中","探索中","资料整理","已完成","已发布","持续更新"];
var appData=JSON.parse(localStorage.getItem("rd_kanban_v2")||"null")||JSON.parse(JSON.stringify(DEFAULT_DATA));
function saveData(){localStorage.setItem("rd_kanban_v2",JSON.stringify(appData))}
...
function renderDaily(){
  ...
  document.getElementById("daily-grid").innerHTML=days.map(function(d){
    var html='<div class="daily-card"><div class="daily-card-header"><span class="date">'+d.date+" "+WEEKDAYS[new Date(d.date).getDay()]+'</span><span class="date-badge '+d.type.replace("yesterday","yesterday").replace("past","yesterday")+'">'+(d.type==="today"?"今天":d.type==="yesterday"?"昨天":fmtDate(d.date))+'</span></div>';
...
// FIXED: setIndexFilter now re-renders controls AND guards index-search access
function setIndexFilter(type,val){
  ...
  // Re-render controls to update active chip states
  renderIndexControls();
  applyIndexFilters();
}
...
function applyIndexFilters(){
  ...
  document.getElementById("index-tbody").innerHTML=entries.map(function(e){
    var dimCls=e.dim.toLowerCase();
    return '<tr>'+
      '<td><span class="dim-badge '+dimCls+'">'+e.dim+'</span></td>'+
      '<td>'+catEmoji(e.cat)+" "+e.cat+'</td>'+
      '<td><strong style="cursor:pointer" onclick="openDetail('+e.id+')" title="点击查看详情">'+e.title+'</strong></td>'+
      '<td>'+(e.link?'<span class="ver-link" onclick="openDetail('+e.id+')" title="'+e.link+'">'+e.ver+'</span>':e.ver)+'</td>'+
...
// ─── DETAIL MODAL (with copyable links) ───
function openDetail(id){
  var e=appData.entries.find(function(x){return x.id===id});
  if(!e)return;
  var linkHtml="";
  if(e.link){
    linkHtml='<div class="modal-field"><label>关联文件</label><div class="val" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap"><code style="background:var(--surface2);padding:4px 8px;border-radius:4px;font-size:0.85em;word-break:break-all">'+e.link+'</code><button class="btn-sm info" onclick="copyPath(\''+e.link.replace(/'/g,"\\'")+'\')">📋 复制路径</button></div></div>';
  }
...
function showToast(msg){
  ...
  style.textContent="@keyframes fadeInOut{0%{opacity:0;transform:translateX(-50%) translateY(10px)}15%{opacity:1;transform:translateX(-50%) translateY(0)}80%{opacity:1}100%{opacity:0}}";
  document.head.appendChild(style);
  document.body.appendChild(t);
  setTimeout(function(){t.remove();style.remove()},2600);
}

// ─── EDIT MODAL ───
function openEditForm(id){
  var e=appData.entries.find(function(x){return x.id===id});if(!e)return;
  var catOpts=CATS.map(function(c){return'<option value="'+c+'"'+(c===e.cat?' selected':'')+'>'+c+'</option>'}).join("");
  var statOpts=STATUSES.map(function(s){return'<option value="'+s+'"'+(s===e.status?' selected':'')+'>'+s+'</option>'}).join("");
  var prioOpts=["高","中","低"].map(function(p){return'<option value="'+p+'"'+(p===e.priority?' selected':'')+'>'+p+'</option>'}).join("");
  document.getElementById("modal-content").innerHTML=
    '<button class="close-btn" onclick="closeModal()">✕</button>'+
    '<h3>✏️ 编辑条目</h3>'+
    ...
    '<div class="modal-field"><label>分类</label><select id="edit-cat" class="form-input">'+catOpts+'</select></div>'+
    ...
    '<div class="modal-field"><label>状态</label><select id="edit-status" class="form-input">'+statOpts+'</select></div>'+
    '<div class="modal-field"><label>优先级</label><select id="edit-priority" class="form-input">'+prioOpts+'</select></div>'+
...
function openAddForm(){
  ...
  var statOpts=STATUSES.map(function(s){return'<option value="'+s+'">'+s+'</option>'}).join("");
  document.getElementById("modal-content").innerHTML=
    '<button class="close-btn" onclick="closeModal()">✕</button>'+
    '<h3>➕ 添加新条目</h3>'+
    ...
    '<div class="modal-field"><label>分类</label><select id="add-cat" class="form-input">'+catOpts+'</select></div>'+
    ...
    '<div class="modal-field"><label>状态</label><select id="add-status" class="form-input">'+statOpts+'</select></div>'+
...
function addEntry(ev){
  ev.preventDefault();
  var entry={
    id:Math.max.apply(null,[0].concat(appData.entries.map(function(e){return e.id})))+1,
...
<header class="header">
  <div class="header-left">
    ...
    <div>
      ...
      <div class="header-tagline">计算范式：从<span class="tcc">节点中心</span>到<span class="inest">拓扑中心</span> | 拓扑中心计算 × 复杂网络涌现智能</div>
    </div>
  </div>
...
<main class="main">
  <div class="paradigm-banner">
    🧠 <strong>核心创新</strong>：将计算范式从「以节点为中心」转向「以拓扑为中心」—— 
    以网络拓扑结构本身作为计算的基本单元，通过 <strong>TCC</strong>（拓扑中心计算）架构与 <em>iNEST</em>（复杂网络涌现智能）框架，
    实现拓扑原生计算与智能涌现
  </div>
  ...
  <div class="view-panel" id="view-index">
    <div class="section-title">🔍 成果索引表 <span class="badge" id="index-badge"></span></div>
    ...
    <div class="table-wrap">
      ...
      <div class="no-results" id="no-results" style="display:none">🔍 未找到匹配的条目 — 尝试调整筛选条件</div>
    </div>
  </div>
</main>
...
print(f"Size: {len(HTML.format(css=CSS, data_json=json.dumps(default_data, ensure_ascii=False), js=JS))} bytes")
