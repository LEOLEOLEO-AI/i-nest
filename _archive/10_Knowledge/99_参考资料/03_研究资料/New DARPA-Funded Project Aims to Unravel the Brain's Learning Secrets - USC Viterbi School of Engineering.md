...
Biomedical engineers at USC Viterbi School of Engineering are embarking on a bold new project to unlock how the brain learns and processes information. The work, funded by the Defense Advanced Research Projects Agency (DARPA), is led by [Dong Song](https://viterbi.usc.edu/directory/faculty/Song/Dong), director of the [USC Neural Modeling and Interface Lab](https://slab.usc.edu/) and associate professor of biomedical engineering and of neurological surgery at [Keck School of Medicine of USC](https://keck.usc.edu/). This new [DARPA INSPIRE](https://www.darpa.mil/research/programs/inspire) (Investigating how Neurological Systems Process Information in Reality) project will delve into the mysteries of Long-Term Synaptic Plasticity (LTSP), the fundamental mechanism by which our brains adapt and form memories.
