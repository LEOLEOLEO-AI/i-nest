...
原文链接: [https://mp.weixin.qq.com/s/iICf_kPCinU18YZyvOcLbw](https://mp.weixin.qq.com/s/iICf_kPCinU18YZyvOcLbw)
...
F**eature **
C**onstruction）、基于特征提出子任务（posing a **
S**ub**
T**ask）、学习一个选项来解决该子任务（learning an **
O**ption）、学习该选项的模型（learning a **
M**odel）、以及使用该选项的模型进行规划（**
P**lanning）。
...
让我们从 OaK 这个名字开始。这个名字源于两个核心概念：“选项”（**
O**ptions）和“知识”（**
K**nowledge）。
...
那么，如何以一种领域无关的方式创造子问题呢？OaK 提出了一种具体机制，称为“尊重奖励的特征达成子问题”（Reward-Respecting, Feature-Achieving Subproblem）。当智能体遇到或创造一个新特征时（例如，听到摇铃的声音），它可以将其作为子问题的基础。这个子问题的目标是：**
在不损失过多主奖励的前提下，将世界驱动到一个该特征值很高的状态。**
...
这个子问题创造机制，是 OaK 架构中一个更宏大流程的核心。我们可以将这个流程总结为一条五步走的演进路径，我们称之为 **
FC-STOMP**：
- 
...
综上所述，OaK 是一个关于如何获得一个完全从经验中成长起来的、开放式的超级智能的构想。它描绘了一个在运行时从经验中培育超级智能的蓝图，整合了行动、学习、规划、模型学习、子问题和选项等核心能力，并结合了函数逼近、部分可观测性、非平稳性等现实挑战。所有这一切，都在一个良性的、开放式的发现循环中协同工作：状态特征的发现，激发了问题、选项和模型的发现，而这些新产生的组件又反过来促进了新的、更抽象特征的形成。作为一个完全通用、不含任何领域特定组件的架构，OaK 具有强大的可扩展性，并有望对人工智能的未来产生深远而
持久的影响。

文章精选：
1.[图灵奖+诺奖双料得主、AI教父Hinton首次现身中国，合照全网刷屏！预警AI觉醒临界点已至](https://mp.weixin.qq.com/s?__biz=MzIyMzk1MDE3Nw==&mid=2247671036&idx=1&sn=e4dd6cd2253965bf4006295ca25866c4&scene=21#wechat_redirect)
2.[图灵奖和诺贝尔奖双料得主、AI教父Hinton教授国内首次演讲PPT全文实录](https://mp.weixin.qq.com/s?__biz=MzIyMzk1MDE3Nw==&mid=2247671057&idx=1&sn=fb5db054514568fc447699086f9b513f&scene=21#wechat_redirect)
3.[图灵奖得主Hinton与姚期智对谈：认为人类的意识特殊，那是危险的无稽之谈](https://mp.weixin.qq.com/s?__biz=MzIyMzk1MDE3Nw==&mid=2247671178&idx=1&sn=5885c4c2920675f30981e25179f51b8a&scene=21#wechat_redirect)
4.[图灵奖得主Rich Sutton ：从数据时代到经验时代的 AI](https://mp.weixin.qq.com/s?__biz=MzIyMzk1MDE3Nw==&mid=2247671178&idx=2&sn=025a4ce555ebc09e7783241caf170d29&scene=21#wechat_redirect)
