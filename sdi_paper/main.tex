...
\begin{table}[H]
\centering
\caption{Experiment 5: Core Metric Summary (mean across 3 random seeds). All 18/18 simulations meet core criteria.}
\label{tab:exp5}
...
Human\_HCP 3-rules & 1.071 & 1.69 & 1.99 & $-1.38$ & 0.45 & 6.3/9 \\
WS\_Control 3-rules & 1.072 & 1.51 & 1.70 & $-1.46$ & 0.48 & 6/9 \\
Best single run & 1.083 & 2.08 & 2.44 & $-1.18$ & 0.50 & 7/9 \\
\midrule
\multicolumn{7}{l}{\textbf{All 18/18 simulations pass}: $\kappa\in[0.9,1.1]$; PSD$\in[-2.0,-0.5]$; decode $>0.05$} \\
\bottomrule
\end{tabular}
\end{table}
...
\end{equation}
where $\kappa < 1$ corresponds to subcritical, $\kappa > 1$ to supercritical, and $\kappa = 1$ to the critical point. All three networks in Experiment 5 show $\kappa$ stable in the range $1.07$--$1.08$, slightly above the theoretical critical point---consistent with \citet{priesemann2014}'s recordings in anesthetized cats and awake mice, where biological neural systems typically operate in the $\kappa \approx 1.00$--$1.08$ sub-supercritical mixed zone.
